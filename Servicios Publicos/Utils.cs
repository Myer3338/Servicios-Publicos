...
namespace Servicios_Publicos
{
    public static class Utils
    {
        ...
        public static string DocUsuario = string.Empty;
        public static string DocActual = string.Empty;
        public static string RolActual = string.Empty;
        public static string UsuarioActual = string.Empty;
        public static string DocCliente = string.Empty;
